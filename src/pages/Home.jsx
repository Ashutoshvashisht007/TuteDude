    ...
    <div className='home'>
      <div className='homeHeading'>
        <div className='homeHeadingUni'>
          <img className='gradLogo' src="images/grad.png" alt="Grad Logo" />
        ...
        <div className="homeHeadingEnroll">
          <button className="homeHeadingEnrollbtn">
            ...
            <img className='homeHeadingEnrollImg' src="images/Group.png" alt="Enroll" />
          </button>
          <button className="homeHeadingKnowMore">
            <span className='homeHeadingKnowMoreSpan'>Know More</span>
            <img className='homeHeadingKnowMoreImg' src="images/questionmark.png" alt="?" />
          </button>
        </div>
      </div>
      ...
      <div className="homeSteps">
        ...
        <div className="homeStepsRefundable">
          ...
          <span className='homeStepsRefundableEnds'>
            <img className='homeStepsRefundableEndsImg' src="images/time.png" alt="Time" />
      ...
      <div className="certificates">
        ...
        <div className='certficatesDiv'>
          ...
          <div className='certifcatesDiv2'> 
            ...
            <img className='certifcatesDiv2_2' src="images/Imagee.png" alt="Image" />
          </div>
        </div>
      </div>
